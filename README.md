About google-cloud-audit-log-feedstock
======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-audit-log-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-audit-log-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-audit-log
# for installing globally
pixi global install google-cloud-audit-log
```
...
It is possible to list all of the versions of `google-cloud-audit-log` available on your platform:
...
```
pixi search google-cloud-audit-log --channel conda-forge
```
